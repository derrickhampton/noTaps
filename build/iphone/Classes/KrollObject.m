 ...
 * Copyright (c) 2009-2011 by comcrazyguysnotabs, Inc. All Rights Reserved.
...
//@interface comcrazyguysnotabsObject : NSObject
//@end

@interface comcrazyguysnotabsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[comcrazyguysnotabsObject class]])
		{
			for (NSString *key in [[(comcrazyguysnotabsObject*)o modules] allKeys])
			{
