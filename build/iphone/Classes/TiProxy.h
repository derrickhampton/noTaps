...
//Rare exceptions to indicate a bug in the _comcrazyguysnotabs code (Eg, function that a subclass should have implemented)
...
/**
 The base class for comcrazyguysnotabs proxies.
 */
