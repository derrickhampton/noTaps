...
@interface comcrazyguysnotabsObject : KrollCoverageObject {
#else
@interface comcrazyguysnotabsObject : KrollObject {
#endif
@private
...
extern NSString * comcrazyguysnotabs$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	comcrazyguysnotabsObject *_comcrazyguysnotabs;
	BOOL shutdown;
