...
/**
 The base class for all comcrazyguysnotabs modules
 */
...
/**
 comcrazyguysnotabs Platform calls this method on startup.
 */
-(void)startup;

/**
 comcrazyguysnotabs Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 comcrazyguysnotabs Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 comcrazyguysnotabs Platform calls this method on resume.
 @param sender The sender of the event.
 */
