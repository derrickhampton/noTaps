...
// in simulator we redefine to format for comcrazyguysnotabs Developer console
...
{\
	NSString * exceptionName = [@"org.comcrazyguysnotabs." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.comcrazyguysnotabs";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIcomcrazyguysnotabsNativeItemNone = -1, 
	UIcomcrazyguysnotabsNativeItemSpinner = -2,
	UIcomcrazyguysnotabsNativeItemProgressBar = -3,
	
	UIcomcrazyguysnotabsNativeItemSlider = -4,
	UIcomcrazyguysnotabsNativeItemSwitch = -5,
	UIcomcrazyguysnotabsNativeItemMultiButton = -6,
	UIcomcrazyguysnotabsNativeItemSegmented = -7,
	
	UIcomcrazyguysnotabsNativeItemTextView = -8,
	UIcomcrazyguysnotabsNativeItemTextField = -9,
	UIcomcrazyguysnotabsNativeItemSearchBar = -10,
	
	UIcomcrazyguysnotabsNativeItemPicker = -11,
	UIcomcrazyguysnotabsNativeItemDatePicker = -12,
	
	UIcomcrazyguysnotabsNativeItemInfoLight = -13,
	UIcomcrazyguysnotabsNativeItemInfoDark = -14,
	
	UIcomcrazyguysnotabsNativeItemDisclosure = -15,
	
	UIcomcrazyguysnotabsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all comcrazyguysnotabs instances of
